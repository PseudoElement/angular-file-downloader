...
import { CreateRoomRespBody, GetRoomByIdRespBody } from '../models/http-models-from-server';
...
export class VoiceChatApiService {
    ...
    public async fetchRoomById(id: string): Promise<GetRoomByIdRespBody> {
        return this.httpApi.get<GetRoomByIdRespBody>(`${ENVIRONMENT.apiBaseUrl}/voicechat/room?room_id=${id}`);
    }
}
